    ...
    <>
      ...
      >
        ...
        <motion.div
          layout
          initial={false}
          className="relative overflow-hidden rounded-xl border border-gray-200 bg-white transition-all duration-300"
        >
                ...
                <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-3">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs text-gray-500">
                      {t("photo.showOnCVDescription") ||
                        "Toggle photo visibility in the preview"}
                    </p>
                  </div>
                  <Switch
