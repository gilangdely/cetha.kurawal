...
export default function RiwayatReviewPage() {
  ...
  return (
    <div className="container py-8">
      <h1 className="mb-6 text-2xl font-bold">Riwayat Review CV</h1>
          ...
          {reviews.map((review) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="truncate font-medium">{review.fileName}</h3>
                ...
                <Link href={`/dashboard/result-cv?reviewId=${review.id}`}>
                  <Button
                    size="sm"
